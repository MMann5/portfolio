# Michael Mann — Portfolio Content

> Brief for Claude Design. Content only — visual direction TBD.
> Tone: professional, premium, minimalist (Linear/Vercel territory).
> Language: English.
...
**Status badge:** Available for new opportunities · Q2 2026
...
**Tags:** React · TypeScript · Tailwind CSS · Supabase · Team leadership

### Role 2 — Limova.ai (France, Remote)
...
**Tagline:** AI voice assistant for business phone reception — answering, qualifying and booking appointments 24/7.
...
**Tags:** React · TypeScript · Tailwind CSS · Supabase · Google OAuth

### Mission 2 — Penpaloo (Remote)

- **Title:** Lead Frontend Developer · Freelance
- **Dates:** Jan 2025 — Sep 2025
- **Duration:** 9 months · Shipped to production
- **URL:** penpaloo.io

**Tagline:** A safe digital penpal platform for kids — building language skills and cultural curiosity through letter exchanges.
...
**Tags:** React · TypeScript · Tailwind CSS · Supabase · Frontend architecture

---

## Side Projects

**Section label:** 04 — Side Projects

**Heading:** Independent products.

**Sub:** SaaS and tools I build, ship and maintain outside of client work.

### Project 1 — Maqom (featured)
...
### Project 2 — AI-Driven Development Methodology

- **Type:** Personal framework
- **Status:** In production
- **Tagline:** A reproducible system for shipping any project from scratch — at AI speed, without losing engineering rigor.
...
React.js · TypeScript · JavaScript ES6+ · React Query · Redux Toolkit · Zustand · Tailwind CSS · shadcn/ui · MUI · PWA · i18n · WCAG · Orval

### Tooling & Architecture

Frontend architecture · Design systems · Component-driven development · Performance (LCP, TTI) · Vite · Vitest · Playwright · Git · GitHub Actions

### Backend & Data

Supabase · PostgreSQL · RLS · NestJS · MongoDB · REST APIs · OpenAPI / Orval · Next.js SSR
...
1. **Claude Code** — Primary agentic IDE for architecture, scaffolding, refactoring and review.
2. **Claude Design** — Design-to-code workflow for high-fidelity UI and design system iteration.
3. **BMAD Methodology** — Structured agentic framework for PRD, architecture and story-driven delivery.
4. **MCP Stack** — Context7, Playwright, Sequential Thinking, Brave Search — connected to every project.
...
© 2026 Michael Mann · All rights reserved
